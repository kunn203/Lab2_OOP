...
sv1 = SinhVien(1234511,'Nguyen Van A',datetime.strptime('12/04/2000','%d/%m/%Y'))
sv2 = SinhVien(1234512,'Nguyen Van B',datetime.strptime('13/04/2000','%d/%m/%Y'))
sv3 = SinhVien(1234513,'Nguyen Van C',datetime.strptime('14/04/2000','%d/%m/%Y'))
